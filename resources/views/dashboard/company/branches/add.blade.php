...
@section('content')
<form role="form" action='{{ url("dashboard/branches") }}' class="form-horizontal" method="post" enctype="multipart/form-data">
    @csrf
    @method("POST")
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{ bs_input("minutes_before_closing",null,true) }}
