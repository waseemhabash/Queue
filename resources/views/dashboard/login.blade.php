...
<body class="login example2">
    <div class="main-login col-sm-4 col-sm-offset-4">
        ...
        <div class="box-login">
            <h3 class="text-center" style="margin-bottom: 46px;">{{ __("dashboard.logIn") }}</h3>
                ...
                <fieldset>
                    <div class="form-group">
                        <span class="input-icon">
                            <input type="text" class="form-control" name="email" placeholder="{{ __('dashboard.email') }}">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn btn-bricky pull-right">
                            {{ __("dashboard.logIn") }} <i class="fa fa-arrow-circle-right"></i>
                        </button>
                    </div>
