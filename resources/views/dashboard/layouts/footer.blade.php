...
<script src="{{ url('/assets/dashboard') }}/assets/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
...
<script src="{{ url('/assets/dashboard') }}/assets/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js"></script>
