...
<head>
    <title>{{ __("dashboard.brand") }} - {{ __("dashboard.".session("c_page")) }}</title>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/plugins/perfect-scrollbar/src/perfect-scrollbar-rtl.css">
    ...
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/css/rtl-version.css">
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/css/jquery-ui.min.css">
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/plugins/select2/select2.css">

    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/plugins/summernote/build/summernote.css">
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/plugins/fullcalendar/fullcalendar/fullcalendar.css">
    <link rel="stylesheet" href="{{ url('/dashboard') }}/assets/css/map-box.css" />
