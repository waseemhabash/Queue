...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" name="<?= $name ?>" placeholder='<?= __("dashboard.$name") ?>' id="<?= $name ?>" class="form-control" <?= $required ? 'required' : '' ?> value="<?= old($name) ?? $value ?? ''  ?>">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="date" name="<?= $name ?>" placeholder='<?= __("dashboard.$name") ?>' id="<?= $name ?>" class="form-control" <?= $required ? 'required' : '' ?> value='<?= old($name) ?? $value ?? ""  ?>'>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="number" name="<?= $name ?>" placeholder='<?= __("dashboard.$name") ?>' id="<?= $name ?>" class="form-control" <?= $required ? 'required' : '' ?> value='<?= old($name) ?? $value ?? ""  ?>'>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="file" accept="image/*" name="<?= $name ?>"  id="<?= $name ?>" class="form-control" <?= $required ? 'required' : '' ?> >
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="file" accept="video/*" name="<?= $name ?>"  id="<?= $name ?>" class="form-control" <?= $required ? 'required' : '' ?> >
    </div>
</div>
